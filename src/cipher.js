const cipher = {
  encode: function (offset, string) {
    if (offset != Number && string == "") {
      throw TypeError("Ops! Precisamos de um número de intervalo e um texto para cifrar!");
    } else {
      let result = "";
  ...
  decode: function (offset, string) {
    if (offset != Number && string == "") {
      throw TypeError("Ops! Precisamos de um número de intervalo e um texto para decifrar!");
    } else {
      let result = "";
      for (let i = 0; i < string.length; i++) {
